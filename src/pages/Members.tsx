...
import { Search, Users, Pencil, Eye, ShieldCheck, UserCheck, UserX } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-4">
        ...
        <Card><CardContent className="p-4 flex items-center gap-3"><div><p className="text-xs text-muted-foreground uppercase tracking-wider">Managers</p><p className="text-2xl font-bold text-blue-600">{managerCount}</p></div><UserCheck className="h-5 w-5 text-blue-600 opacity-40" /></CardContent></Card>
      </div>
